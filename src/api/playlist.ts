 ...
 */
export const recommendPlaylist = (params: any) => {
    return request({
        url: '/personalized',
        method: 'get',
        params,
 ...
 * @param {number=} params.limit
 */
export const dailyRecommendPlaylist = (params: any) => {
    return request({
 ...
 */
export const highQualityPlaylist = (params: any) => {
    return request({
 ...
 * @param {number=} params.limit
 */
export const topPlaylist = (params: any) => {
    return request({
        url: '/top/playlist',
        method: 'get',
        params,
 ...
 */
export const subscribePlaylist = (params: any) => {
 ...
 */
export const createPlaylist = (params: any) => {
    params.timestamp = new Date().getTime();
    return request({
        url: '/playlist/create',
        method: 'post',
 ...
 */
export const addOrRemoveTrackFromPlaylist = (params: any) => {
    params.timestamp = new Date().getTime();
    return request({
        url: '/playlist/tracks',
        method: 'post',
 ...
 */
export const intelligencePlaylist = (params: any) => {
    return request({
